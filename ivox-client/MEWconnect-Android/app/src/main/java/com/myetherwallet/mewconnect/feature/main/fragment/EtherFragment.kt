...
import kotlinx.android.synthetic.main.fragment_ether.*
import okhttp3.*
...
class EtherFragment : BaseDiFragment(), Toolbar.OnMenuItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as MainActivity).setupDrawer(ether_toolbar)
    ...
    private fun collect() {
        this.activity?.runOnUiThread(java.lang.Runnable {
            ...
            if(ether_list != null){
                ether_list.adapter = tokensListAdapter

                ether_list.setOnItemClickListener{ parent, view, position, id ->
    ...
    override fun layoutId() = R.layout.fragment_ether
}